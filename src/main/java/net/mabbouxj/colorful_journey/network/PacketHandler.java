package net.mabbouxj.colorful_journey.network;

import it.unimi.dsi.fastutil.bytes.Byte2ObjectArrayMap;
import it.unimi.dsi.fastutil.bytes.Byte2ObjectMap;
import net.mabbouxj.colorful_journey.ColorfulJourney;
import net.mabbouxj.colorful_journey.network.packets.IPacket;
import net.mabbouxj.colorful_journey.network.packets.IPacketClient;
...
public class PacketHandler {
    ...
    private static final Logger LOG = LogManager.getLogger(ColorfulJourney.MOD_ID + ".PacketHandler");
