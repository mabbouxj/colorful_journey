...
public interface INBTHandler<T> {
     ...
     */
    boolean storeToNBT(@Nonnull CompoundNBT compound, @Nonnull String name, @Nonnull T object);
     ...
     */
    T readFromNBT(@Nonnull CompoundNBT compound, @Nonnull String name, @Nullable T currentValue);
}