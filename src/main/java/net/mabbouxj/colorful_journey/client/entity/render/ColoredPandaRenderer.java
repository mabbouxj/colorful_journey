...
import net.mabbouxj.colorful_journey.entities.ColoredPandaEntity;
...
public class ColoredPandaRenderer extends MobRenderer<ColoredPandaEntity, PandaModel<ColoredPandaEntity>> {

    private static final Map<PandaEntity.Gene, ResourceLocation> TEXTURES = Util.make(Maps.newEnumMap(PandaEntity.Gene.class), (variants) -> {
        variants.put(PandaEntity.Gene.NORMAL, new ResourceLocation("textures/entity/panda/panda.png"));
        variants.put(PandaEntity.Gene.LAZY, new ResourceLocation("textures/entity/panda/lazy_panda.png"));
        variants.put(PandaEntity.Gene.WORRIED, new ResourceLocation("textures/entity/panda/worried_panda.png"));
        variants.put(PandaEntity.Gene.PLAYFUL, new ResourceLocation("textures/entity/panda/playful_panda.png"));
        variants.put(PandaEntity.Gene.BROWN, new ResourceLocation("textures/entity/panda/brown_panda.png"));
        variants.put(PandaEntity.Gene.WEAK, new ResourceLocation("textures/entity/panda/weak_panda.png"));
        variants.put(PandaEntity.Gene.AGGRESSIVE, new ResourceLocation("textures/entity/panda/aggressive_panda.png"));
    });

    public ColoredPandaRenderer(EntityRendererManager renderManager) {
        super(renderManager, new PandaModel<>(9, 0.0F), 0.9F);
        this.addLayer(new ColoredMobLayer<>(this));
    }

    @Override
    public ResourceLocation getTextureLocation(ColoredPandaEntity entity) {
        return TEXTURES.getOrDefault(entity.getVariant(), TEXTURES.get(PandaEntity.Gene.NORMAL));
    }

    protected void setupRotations(ColoredPandaEntity p_225621_1_, MatrixStack p_225621_2_, float p_225621_3_, float p_225621_4_, float p_225621_5_) {
