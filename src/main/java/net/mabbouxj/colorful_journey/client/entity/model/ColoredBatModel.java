...
@OnlyIn(Dist.CLIENT)
public class ColoredBatModel extends SegmentedModel<ColoredBatEntity> {
    ...
    public void setupAnim(ColoredBatEntity entity, float p_225597_2_, float p_225597_3_, float p_225597_4_, float p_225597_5_, float p_225597_6_) {
        if (entity.isResting()) {
